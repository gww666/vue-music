<template>
    <div class="music-list">
        ...
        <div class="bg-image" ref="bgImage" :style="bgImage">
...
<script>
    ...
    export default {
        ...
        mounted () {
            ...
            // }, 20);
            // console.log(this.$refs.list);
            this.bgImgHeight = this.$refs.bgImage.offsetHeight;
            this.minTranslateY = this.bgImgHeight - RESERVED_HEIGHT;
            this.$refs.list.$el.style.top = this.$refs.bgImage.offsetHeight + "px";
        }
